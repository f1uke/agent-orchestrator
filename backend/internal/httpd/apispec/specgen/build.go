...
var schemaNames = map[string]string{
	...
	"ControllersSetSessionTargetRequest":          "SetSessionTargetRequest",
	...
	"ControllersWorkspaceResolveParams":           "WorkspaceResolveParams",
...
func simOperations() []operation {
	return []operation{
		...
		},
		{
			...
			pathParams: []any{controllers.SimSessionDeviceParam{}},
			reqBody:    controllers.SimGestureInput{},
			resps: []respUnit{
				{http.StatusOK, controllers.SimGestureResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusUnprocessableEntity, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
		...
		{
			method: http.MethodPost, path: "/api/v1/sessions/{sessionId}/sim-recordings/{udid}", id: "startSimRecording", tag: "sim",
			summary:    "Start capturing this session's gestures on a simulator it already leases",
			pathParams: []any{controllers.SimLeaseParam{}},
			reqBody:    controllers.StartSimRecordingInput{},
			resps: []respUnit{
				{http.StatusOK, controllers.SimRecordingResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusUnprocessableEntity, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
...
func sessionOperations() []operation {
	return []operation{
		...
		},
		{
			...
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.SetSessionTargetRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.SessionResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/workspace/resolve", id: "resolveWorkspaceRef", tag: "sessions",
			summary:    "Resolve a terminal file reference to candidate workspace paths",
			pathParams: []any{controllers.SessionIDParam{}, controllers.WorkspaceResolveParams{}},
			resps: []respUnit{
				{http.StatusOK, controllers.WorkspaceResolveResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
			},
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/workspace/file", id: "readWorkspaceFile", tag: "sessions",
			summary:    "Return a workspace file's content and per-line uncommitted-change map",
		...
		{
			method: http.MethodPut, path: "/api/v1/sessions/{sessionId}/workspace/file", id: "writeWorkspaceFile", tag: "sessions",
			summary:    "Replace a workspace file's content (confined, hash-preconditioned)",
			pathParams: []any{controllers.SessionIDParam{}},
			reqBody:    controllers.WriteWorkspaceFileRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.WriteWorkspaceFileResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
...
func settingsOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodPut, path: "/api/v1/wiki/file", id: "writeWikiNote", tag: "wiki",
			summary: "Replace one note's markdown, preconditioned on the hash it was read with",
		...
		{
			method: http.MethodPost, path: "/api/v1/wiki/tasks/delete", id: "deleteWikiTask", tag: "wiki",
			summary: "Delete one task row from its note, matched on its exact text so a stale row is refused",
			reqBody: controllers.DeleteWikiTaskRequest{},
			resps: []respUnit{
				{http.StatusOK, controllers.DeleteWikiTaskResponse{}},
				{http.StatusBadRequest, envelope.APIError{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
