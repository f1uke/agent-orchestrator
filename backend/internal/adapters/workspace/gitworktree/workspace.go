...
// restorePath resolves the on-disk worktree path for a Restore/registration:
// an explicit cfg.Path (a saved workspace worktree marker) is validated as-is,
// otherwise it falls back to the managed, branch-mirrored path.
