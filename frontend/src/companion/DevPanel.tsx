...
export type DevPanelProps = {
	...
	/** Which character the whole band is drawn as. `mixed` deals all four round. */
	species: SpeciesId | "mixed";
	onSpecies: (species: SpeciesId | "mixed") => void;
	/** Opens the full contact sheet: every character, every state, every wallpaper tone. */
	onConceptSheet: () => void;
};
...
export function DevPanel({
	...
	return (
		<div style={SHELL}>
			...
			<Section title="Character (the species axis)">
				<div style={ROW_OF_BUTTONS}>
					{[
