...
export function NotificationCenter({ style }: NotificationCenterProps) {
	...
	return (
		// The shared DropdownMenu primitive is non-modal and skips the close-time
		// focus return on an outside pointer press (see ui/dropdown-menu.tsx +
		// overlay-focus.ts), so a single click on the terminal both closes this
		// popover and focuses the terminal — no bell-side handling needed.
		<DropdownMenu>
